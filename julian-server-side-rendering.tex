...
\begin{itemize}
  \setlength\itemsep{1em}
  \item  \textbf{SSR} Server-Side Rendering: Rendern auf der Server Seite bezieht sich auf das generieren eines HTML Dokumentes 
  aus einer Single Page Application. 
  \item  \textbf{CSR} Client-Side Rendering: Rendern auf der Client Seite bezieht sich auf das generieren und parsen eines 
...
\begin{figure}[h]
  ...
  \caption{HTML Antwort einer SPA \textit{React} Anwendung}
...
Sie lassen sich mit Hilfe von Frameworks wie \textit{React} komfortabel entwickeln
...
Das Rendern einer 1 Megabyte Anwendung mit hilfe der \textit{renderToString() }
